  ...
  if (oldViewProps.timeLineFillBottomColor != newViewProps.timeLineFillBottomColor) {
    if (newViewProps.timeLineFillBottomColor.size() != 0) {
      ...
      _klineCharView.timeLineFillBottomColor = [self hexStringToColor:colorToConvert];
        ...
        // 实时k线文字的颜色
        if (oldViewProps.priceLabelRightTextColor != newViewProps.priceLabelRightTextColor) {
          if (newViewProps.priceLabelRightTextColor.size() != 0) {
            NSString * colorToConvert = [[NSString alloc] initWithUTF8String: newViewProps.priceLabelRightTextColor.c_str()];
            _klineCharView.priceLabelRightTextColor = [self hexStringToColor:colorToConvert];
          }
        }
    
        // 实时k线背景的颜色
        if (oldViewProps.priceLabelRightBackgroundColor != newViewProps.priceLabelRightBackgroundColor) {
          if (newViewProps.priceLabelRightBackgroundColor.size() != 0) {
            NSString * colorToConvert = [[NSString alloc] initWithUTF8String: newViewProps.priceLabelRightBackgroundColor.c_str()];
            _klineCharView.priceLabelRightBackgroundColor = [self hexStringToColor:colorToConvert];
          }
        }
    
        // 实时k线文字的颜色
        if (oldViewProps.gridLineColor != newViewProps.gridLineColor) {
          if (newViewProps.gridLineColor.size() != 0) {
            NSString * colorToConvert = [[NSString alloc] initWithUTF8String: newViewProps.gridLineColor.c_str()];
            _klineCharView.gridLineColor = [self hexStringToColor:colorToConvert];
          }
        }
  if (oldViewProps.ma1Color != newViewProps.ma1Color) {
    if (newViewProps.ma1Color.size() != 0) {
      NSString * colorToConvert = [[NSString alloc] initWithUTF8String: newViewProps.ma1Color.c_str()];
      _klineCharView.ma1Color = [self hexStringToColor:colorToConvert];
    }
  }
  if (oldViewProps.ma2Color != newViewProps.ma2Color) {
    if (newViewProps.ma2Color.size() != 0) {
      NSString * colorToConvert = [[NSString alloc] initWithUTF8String: newViewProps.ma2Color.c_str()];
      _klineCharView.ma2Color = [self hexStringToColor:colorToConvert];
    }
  }
  if (oldViewProps.ma3Color != newViewProps.ma3Color) {
    if (newViewProps.ma3Color.size() != 0) {
      NSString * colorToConvert = [[NSString alloc] initWithUTF8String: newViewProps.ma3Color.c_str()];
      _klineCharView.ma3Color = [self hexStringToColor:colorToConvert];
    }
  }
  if (oldViewProps.volMa1Color != newViewProps.volMa1Color) {
    if (newViewProps.volMa1Color.size() != 0) {
      NSString * colorToConvert = [[NSString alloc] initWithUTF8String: newViewProps.volMa1Color.c_str()];
      _klineCharView.volMa1Color = [self hexStringToColor:colorToConvert];
    }
  }
  if (oldViewProps.volMa2Color != newViewProps.volMa2Color) {
    if (newViewProps.volMa2Color.size() != 0) {
      NSString * colorToConvert = [[NSString alloc] initWithUTF8String: newViewProps.volMa2Color.c_str()];
      _klineCharView.volMa2Color = [self hexStringToColor:colorToConvert];
    }
  }
  // 分时线呼吸灯的颜色
