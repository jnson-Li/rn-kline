...
export interface Spec extends TurboModule {
     ...
     */
    resetData(list: KLineEntity[], resetShowPosition?: boolean, resetLastAnim?: boolean): void;
    /**
     * @name 添加新数据
     * @param data K线数据
    ...
    changeLast(data: KLineEntity): void;
}
declare const _default: Spec;
export default _default;
//# sourceMappingURL=NativeKlineAdapter.d.ts.map