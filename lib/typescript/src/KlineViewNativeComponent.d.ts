...
export declare enum CrossFollowTouch {
    /** 跟随手指移动 */
    TOUCH_FOLLOW_FINGERS = 2001,
    /** y值显示当前价格 */
    TOUCH_SHOW_CLOSE = 2002
}
export declare enum YLabelState {
    /** Y轴显示在网格上 */
    LABEL_WITH_GRID = 8001,
    /** Y轴独立显示与网格不重叠 */
    LABEL_NONE_GRID = 8002
}
export declare enum MaxMinCalcModel {
    /** 计算显示的线全部值 */
    CALC_NORMAL_WITH_SHOW = 7001,
    /** 计算显示的线的close值 */
    CALC_CLOSE_WITH_SHOW = 7002,
    /** 计算显示的线和最新线的全部值 */
    CALC_NORMAL_WITH_LAST = 7003,
    /** 计算显示的线和最新线的close值 */
    CALC_CLOSE_WITH_LAST = 7004
}
export declare enum MainDrawType {
    /** 显示ma */
    MA = 1001,
    /** 显示boll */
    BOLL = 1002,
...
export declare enum IndexdDrawType {
    /** 不显示子图 */
    NONE = 4001,
    MACD = 4002,
    KDJ = 4003,
...
export declare enum KLineState {
    TIME_LINE = 4102,
    K_LINE = 4103
}
export declare enum SelectedTouchModle {
    /** 点击显示 */
    SELECT_TOUCHE = 5001,
    /** 长按显示 */
    SELECT_PRESS = 5002,
...
export declare enum VolChartType {
    /** 柱状图 */
    BAR_CHART = 4100,
    /** 线状图 */
    VERTICAL_BAR = 4101
...
export declare enum CandleHollow {
    ...
    ALL_HOLLOW = 6002,
    /** 上涨的值空心 */
    DECREASE_HOLLOW = 6003,
    /** 下跌的值空心 */
    INCREASE_HOLLOW = 6004
}
declare const _default: import("react-native/Libraries/Utilities/codegenNativeComponent").NativeComponentType<NativeProps>;
export default _default;
//# sourceMappingURL=KlineViewNativeComponent.d.ts.map